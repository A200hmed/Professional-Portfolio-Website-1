...
const JSON_DEFAULT = {
  personalInfo: {
    name: 'Ahmed Khaled Anwar', title: 'Software Engineer & Educational Content Creator',
    bio: '', avatar: '', resumeUrl: '', location: 'Cairo, Egypt', email: '',
    whatsapp: '', githubUrl: '', linkedinUrl: '', youtubeUrl: '',
    facebookUrl: '', instagramUrl: '', telegramUrl: '', twitterUrl: ''
  },
  skills: [], languages: [], timeline: [],
  achievements: [], testimonials: [],
  certificates: [], youtubeVideos: [], messages: [], projects: []
};
  ...
  if (isConnected) {
    try {
      ...
      switch (fieldName) {
        ...
        case 'timeline': Model = Timeline; break;
        case 'achievements': Model = Achievement; break;
        case 'testimonials': Model = Testimonial; break;
        default: throw new Error('Unknown array field: ' + fieldName);
      }
...
module.exports = {
  ...
  PersonalInfo, Skill, Language, Timeline, Achievement, Testimonial, Certificate, YoutubeVideo, Project, Message
};
